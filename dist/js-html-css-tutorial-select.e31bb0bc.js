...
var Select = /*#__PURE__*/function () {
  function Select(rootElement, options) {
  ...
  _createClass(Select, [{
    ...
    value: function listClickHandler(evt) {
    ...
    value: function select(id) {
      ...
      this.selectElement.querySelectorAll('[data-type="item"').forEach(function (element) {
        element.classList.remove('selected');
      });
      this.selectElement.querySelector("[data-id=\"".concat(id, "\"]")).classList.add('selected');
    ...
    get: function get() {
      ...
      return this.options.selectItems.find(function (item) {
...
var _getTemplate2 = function _getTemplate2() {
  var placeholder = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Placeholder';
...
var _render2 = function _render2() {
  var _this$options = this.options,
      ...
      selectItems = _this$options.selectItems,
      selectedId = _this$options.selectedId;
  this.rootElement.innerHTML = _classPrivateMethodGet(this, _getTemplate, _getTemplate2).call(this, placeholder, selectItems);
...
},{"./bundle-url":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"select/styles.scss":[function(require,module,exports) {
...
var selectRootElement = document.querySelector('#select-root');
var select = new _select.Select(selectRootElement, {
...
//# sourceMappingURL=/js-html-css-tutorial-select.e31bb0bc.js.map